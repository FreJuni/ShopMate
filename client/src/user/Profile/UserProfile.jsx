            ...
            <div className=" pt-20">
                <form className='max-xl:my-10 max-sm:p-5  shadow-md p-10 rounded-sm w-5/5  mx-5 ' encType='multipart/form-data'>
                    ...
                    <div className='max-lg:grid-cols-1 max-sm:gap-3 grid gap-6 grid-cols-[330px_minmax(0,1fr)]  '>
                        ...
                        <div className=''>
                            <div className='max-sm:grid-cols-1 grid grid-cols-1 xl:grid-cols-2 gap-x-10 gap-y-3'>
                                <div className=''>
                            ...
                            <div className=' pt-3'>
                                <button type='submit' onClick={submitHandler} className=' mt-2 rounded-md max-sm:p-1  cursor-pointer hover:shadow-sm duration-75 bg-blue-500 text-white w-full p-2 font-semibold text-lg'>{loading ? "Loading ..." : 'Update'}</button>
